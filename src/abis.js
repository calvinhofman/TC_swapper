export const tokenABI = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "amountUSD_", type: "uint256" },
  ...
  },
  {
    ...
    name: "saleRounds",
    outputs: [
      { internalType: "uint256", name: "roundPrice", type: "uint256" },
      { internalType: "uint256", name: "roundSupply", type: "uint256" },
      { internalType: "uint256", name: "roundStart", type: "uint256" },
      { internalType: "uint256", name: "roundEnd", type: "uint256" },
      { internalType: "uint256", name: "roundSales", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "bool", name: "canClaim_", type: "bool" }],
    name: "setClaimStatus",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
